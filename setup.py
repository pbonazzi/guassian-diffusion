...
ext_modules = [
    CppExtension('src._C', [
        'src/csrc/ext.cpp',
        'src/csrc/rasterize_points_cpu.cpp',
    ])
]
include_dirs = torch.utils.cpp_extension.include_paths()
ext_modules += [
    CUDAExtension('src._C', [
        'src/csrc/ext.cpp',
        'src/csrc/rasterize_points.cu',
        'src/csrc/rasterize_points_backward.cu',
        'src/csrc/rasterize_points_cpu.cpp',
    ],
...
setup(
    ...
    author='Pietro Bonazzi, Marie-Julie Rakatosaona and Marco Cannici',
