...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('-d', '--device', dest='device', default='cuda:0',help='Device to run the computations on, options: cpu, cuda:{ID}')
        ...
        parser.add_argument('-C', '--cycles', type=int, default=12, help="number of (step_point, step_normal) optimization cycles")
        parser.add_argument('--modifiers', type=str, nargs='+', default=['localNormals', 'localPoints'])
