...
def estimate_pointcloud_local_coord_frames(
    ...
    knn_result = knn_points(points_padded, points_padded,
        lengths1=num_points,
        lengths2=num_points,
        K=neighborhood_size,
        return_nn=True,
    ...
    _, S, local_coord_frames = batch_svd(per_pts_diff+1e-17)
...
def estimate_pointcloud_normals(
    ...
    Returns:
      **normals**: A tensor of normals for each input point of shape `(minibatch, num_point, 3)`.
